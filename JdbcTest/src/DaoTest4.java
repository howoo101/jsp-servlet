...
public class DaoTest4 {
    ...
    public static void main(String[] args) throws SQLException{
    	...
    	User4 u = selectUser("ff22f"); // 객체 u에 저장된 user_id와 동일한 행의 정보를 update하는 메서드
	    System.out.println(u);
	}

	/*
	 * user_id를 매개변수로 받아 user_info테이블에서 해당 사용자의 정보를 가져오는 selectUser메서드를 작성하시오. 
	 */
    static User4 selectUser(String userId) throws SQLException{
	 ...
	 */
	static int updateUser(User4 u) throws SQLException {
	 ...
	 * 데이터가 잘저장되었는지 DB에서 확인하시오)
	 */
	static int insertUser(User4 u) throws SQLException{
		/*
...
class User4 {
	...
	User4() {
 	...
 	User4(String id, String name, String pwd, String mail) {
		this.id = id;
		this.name = name;
		this.pwd = pwd;
		this.mail = mail;
